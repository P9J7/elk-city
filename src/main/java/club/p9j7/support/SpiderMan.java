...
public class SpiderMan {
    ...
    @Autowired
    public SpiderMan(HouseSpider houseSpider, AqiSpider aqiSpider) {
        this.houseSpider = houseSpider;
        this.aqiSpider = aqiSpider;
    }

    public void crawlHouse(String city) {
        Spider houseSpider = Spider.create(this.houseSpider).setScheduler(new FileCacheQueueScheduler("D:\\lianjiaSpider")).addPipeline(this.houseSpider.housePipeline).thread(10);
    ...
    public void crawlHouse() {
        Spider houseSpider = Spider.create(this.houseSpider).setScheduler(new FileCacheQueueScheduler("D:\\AlllianjiaSpider")).addPipeline(this.houseSpider.housePipeline).thread(5);
