...
CREATE TABLE `house` (
  ...
  `huxing` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `louceng` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `jianzhumianji` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `huxingjiegou` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `taoneimianji` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `jianzhuleixing` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `fagnwuchaoxing` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `jianzhujiegou` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `zhuangxiuqingkuang` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `tihubili` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `peibeidianti` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `chanquannianxian` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `guapaishijian` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `jiaoyishuxing` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `shangcijiaoyi` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `fangwuyongtu` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `fangwunianxian` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `chanquansuoshu` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `diyaxinxi` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `fangbenbeijian` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
